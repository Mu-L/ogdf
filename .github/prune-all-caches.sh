...
KEYS=(
  ...
  "ccache-build-conda-ubuntu-latest-debug"
  "ccache-build-conda-ubuntu-latest-release"
  "ccache-build-conda-macos-latest-debug"
  "ccache-build-conda-macos-latest-release"
  "ccache-build-conda-windows-latest-debug"
  "ccache-build-conda-windows-latest-release"
